...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        --help|-h)
            ...
            echo "  - checkin        Checkin Service (Go, gRPC 50059)"
...
start_payment_service() {
    ...
    kill_port 8080 "payment-service-http"
    kill_port 50062 "payment-service-grpc"
...
echo "  PostgreSQL:  localhost:50432 (auth) / localhost:50433 (main)"
echo "  Redis:       localhost:50379"
echo ""
