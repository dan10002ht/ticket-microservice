...
CREATE INDEX IF NOT EXISTS idx_checkins_event_time ON checkins (event_id, check_in_time DESC);
CREATE INDEX IF NOT EXISTS idx_checkins_gate       ON checkins (event_id, gate);
