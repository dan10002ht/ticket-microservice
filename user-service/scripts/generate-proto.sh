...
# Generate Go protobuf files for user-service
...
print_status "Generating Go protobuf files for user-service"
...
print_status "Generating user.proto..."
protoc \
    --go_out="$OUTPUT_DIR" \
